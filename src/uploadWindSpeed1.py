...
wind_df = pd.read_csv("data/windSpeed.csv", parse_dates=['date'])
...
wind_df = wind_df[['station_id', 'week_start', 'wspd']]

# We'll write results to this file in chunks
output_file = "grid_with_windSpeed.csv"
first_chunk = True
...
for week in grid_with_stations['week_start'].drop_duplicates():
    ...
    merged = merged[['grid_id', 'week_start', 'wspd']]
